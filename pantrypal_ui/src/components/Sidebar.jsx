...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-[#FFF6DF] border-r border-[#f0e3c6] flex flex-col justify-between">
  ...
  <img
    ...
    className="h-10 w-auto object-contain"/>
        ...
        <nav className="flex flex-col gap-1">
          ...
          <NavLink to="/insights" className={getNavClasses}>
            <span className={iconCircle}>📊</span>
      ...
      <div className="pb-6">
        ...
        <button className="mt-1 ml-2 mr-2 w-[calc(100%-1rem)] text-left">
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-[#c64b3b] hover:bg-[#ffe1ba] cursor-pointer">
            <span className={iconCircle}>⏏️</span>
            <span>Log Out</span>
          </div>
        </button>
